...
import { SearchTab, ServiceSearchFormFields } from "../type";
...
const Header3: FC<Header3Props> = ({ className = "" }) => {
  ...
  //
  const [showHeroSearch, setShowHeroSearch] = useState<keyof ServiceSearchFormFields | null>(null);
  //
  const [currentTab, setCurrentTab] = useState<SearchTab>("Services");
    ...
    return (
      ...
      >
        ...
        <div
          ...
          onClick={() => setShowHeroSearch("service")}
        >
          <span className="w-8 h-8 flex items-center justify-center rounded-full bg-burgundy-600 text-white">
