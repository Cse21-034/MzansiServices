      ...
      <div className="grid gap-8 lg:grid-cols-1">
        {headerLanguage.map((item, index) => (
          <a
            ...
            href={item.href}
            onClick={() => close()}
            className={`flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus-visible:ring focus-visible:ring-[#612C30] focus-visible:ring-opacity-50 ${
